...
git branch -M main
git remote add origin git@github.com:Anna-MarieSeelen/server-usage-slurm
```

## Push the initial commit to a new repo on GitHub

Go to
[https://github.com/organizations/Anna-MarieSeelen/repositories/new](https://github.com/organizations/Anna-MarieSeelen/repositories/new)
and create a new repository named `server-usage-slurm` as an empty repository, then push your commits to GitHub:
...
automatically ([here](https://github.com/Anna-MarieSeelen/server-usage-slurm/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
